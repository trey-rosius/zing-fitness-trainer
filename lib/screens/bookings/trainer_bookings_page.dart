...
class TrainerBookingsPage extends StatefulWidget {
  TrainerBookingsPage(this.userId,this.userType);
  final String userId;
  final String userType;

  @override
  _TrainerBookingsPageState createState() => _TrainerBookingsPageState();
}

class _TrainerBookingsPageState extends State<TrainerBookingsPage> with SingleTickerProviderStateMixin{
