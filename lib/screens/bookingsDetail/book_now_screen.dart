...
import 'package:zing_fitnes_trainer/screens/trainers/trainer_auto_booking_screen.dart';
    ...
    }else
    {
      for(int i = 0; i<= trainerList.length-1;i++){
        calculateDistance(trainerList[i]).then((value){
          ...
          distanceModel = DistanceModel(distance: value,trainerId: trainerList[i].userId);
          ...
          if(i == trainerList.length-1){
            ...
            print("distance list sorted" + distanceModelList[0].trainerId);
              ...
              MaterialPageRoute(builder: (context) {
                return StreamProvider.value(
                    value: ProfileProvider.instance()
                        .streamTrainerUserProfile(distanceModelList[0].trainerId),
                    catchError: (context, error) {
                      print(error);
                    },
                    child: TrainerAutoBookingsScreen(widget.userId,widget.bookingModel));
