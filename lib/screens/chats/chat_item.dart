...
class _ChatItemState extends State<ChatItem> {
  ...
  Future<Null> blockOptions(BuildContext context, String messageId) async {
    return showDialog<Null>(
      context: context,
      barrierDismissible: false, // user must tap button!
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(10.0),
                  child: Text("Block Message?",style: TextStyle(
                      fontSize: 18.0
                  ),),
                ),
              )
    ...
    if (widget.listMessage[widget.index].receiverId !=
      ...
      Column(
        ...
        children: <Widget>[
          Material(
            child: Hero(
              tag: widget.listMessage[widget.index].messageId??12343,
      ...
      return widget.listMessage[widget.index].visible[widget.senderId] ?
        ...
        onLongPress: (){
          ...
          blockOptions(context,widget.listMessage[widget.index].messageId);
        },
        child: Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  InkWell(
                                    ...
                                    child: Material(
                                      child: Hero(
                                        tag: widget.listMessage[widget.index].messageId??1232,
                                        child: CachedNetworkImage(
        ...
        child: InkWell(
          ...
          onLongPress: (){
            Map map = Map<String,bool>();
            map[widget.senderId] = true;
            map[widget.receiverId] = true;

            ChatsRepository.instance().unBlockLeftMessage(map, widget.chatId, widget.listMessage[widget.index].messageId);
          },
          child: Container(
