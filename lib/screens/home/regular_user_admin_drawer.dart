...
class RegularUserAdminDrawer extends StatefulWidget {
  RegularUserAdminDrawer(this.userId, this.admin, this.menuController,this.userType);
  final String userId;
  final bool admin;
  ...
  @override
  _RegularUserAdminDrawerState createState() => _RegularUserAdminDrawerState();
}

class _RegularUserAdminDrawerState extends State<RegularUserAdminDrawer> {
      ...
      child: Container(
          ...
          child: Column(
            children: <Widget>[
              ...
              .streamGeneralUserModel(widget.userId),catchError: (context,error){
